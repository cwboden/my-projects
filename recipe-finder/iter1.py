...
titles = tree.xpath('body/span/div/span/section/div/article/a[@class="view-complete-item"]')
...
# subsections = tree.xpath('body/div/div/div/div/div/div/div/div/ol/li[@class="ingredient-group"]')
ingredients = tree.xpath('body/div/div/div/div/div/div/div/div/ol/li/ul[@class="ingredients"]/*')
steps = tree.xpath('body/div/div/div/div/div/div/div/div/ol/li/ol[@class="preparation-steps"]/*')
