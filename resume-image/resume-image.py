...
class ResumeImageAdder:
    ...
    def get_option_parser(self):
        ...
        parser.add_option("-i", "--image", dest="image", help="Path to single image to add")
        parser.add_option("-f", "--folder", dest="folder", help="Path to folder of images to add", default="logos/")
        parser.add_option("-r", "--resume", dest="resume", help="Path to resume to add images to", default="resume.pdf")
        parser.add_option("-o", "--output", dest="output", help="Path to folder where new resumes should be saved", default="")
